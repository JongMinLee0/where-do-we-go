...
public class EnrollProjectService implements Service {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			// 파일 기본경로 _ 상세경로
			String filePath = "/Users/leejongmin/git/where-do-we-go/WebContent/pro_image/";
			...
			sFileInfo += "&sFileURL="+"/semiproject/pro_image/"+realFileNm;
